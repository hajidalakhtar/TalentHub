...
type CreateEmployeeRequest struct {
	...
	IdentityExpiryDate string `json:"identity_expiry_date"`
	...
	EndStatusDate  string `json:"end_status_date"`
	...
	BPJSKetenagaKerjaDate   string `json:"bpjs_ketenaga_kerja_date"`
	BPJSKesehatanNumber     string `json:"bpjs_kesehatan_number"`
	BPJSKesehatanFamily     string `json:"bpjs_kesehatan_family"`
	BPJSKesehatanDate       string `json:"bpjs_kesehatan_date"`
	...
	JaminanPensiunDate      string `json:"jaminan_pensiun_date"`
}
